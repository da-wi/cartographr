.onAttach <- function(libname, pkgname) {
  ...
  sysfonts::font_add("Cinzel",
                     ...
                     bold = system.file(package = "cartographr", "fonts","Cinzel","Cinzel-SemiBold.ttf", mustWork = T) )
  ...
  cli::cli_inform(paste0(crayon::blue("cartographr")," ready."), class = "packageStartupMessage",wrap = F)
}
