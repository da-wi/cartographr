...
Create a tibble `df_pal` that contains a list of palette names. Then, use a row-wise operation to apply each palette to our map data (osm) and store the resulting plot object.
